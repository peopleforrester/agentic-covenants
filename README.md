...
- **The gap is measured, and it is infrastructure.** Of organizations that reported a security incident involving an AI model or application, **92% were missing role-based access, MFA, and similar controls** on it (IBM Cost of a Data Breach 2026, 29 July 2026, as reported in [Help Net Security's coverage](https://www.helpnetsecurity.com/2026/07/30/ibm-cost-of-a-data-breach-2026/); this figure is not in IBM's own release). Those are not exotic controls. The same organizations apply them to their databases. They did not apply them to the agent.
