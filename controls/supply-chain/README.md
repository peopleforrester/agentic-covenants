...
- **Client-side**: NIST CSF 2.0 PR.PS-02, PR.PS-01, ID.SC-04 (supplier integrity verified); NIST AI RMF MAP 4.1, MANAGE 3.1 (third-party risk treatment); OWASP LLM03 (Supply Chain), LLM04 (Data and Model Poisoning); OWASP ASI04, ASI06 (Memory & Context Poisoning); NIST SP 800-218 PS.2; NIST SP 800-218A (Generative AI Profile of SSDF); OWASP MCP01, MCP03, MCP04.
- **Server-side**: NIST CSF 2.0 PR.PS-02, PR.PS-05, PR.IR-01, GV.SC-07, ID.SC-04, ID.RA-09 (vulnerability disclosure); NIST AI RMF MAP 4.1, MANAGE 3.1; OWASP LLM03, LLM04; OWASP ASI04; OWASP MCP04, MCP09; NIST SP 800-218 PS.3; NIST SP 800-161 Rev. 1 (supply chain risk management); SLSA framework (build provenance); CISA/NSA/FBI AI Data Security CSI (May 2025).
