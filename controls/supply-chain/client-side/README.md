...
NIST CSF 2.0 PR.PS-02, PR.PS-01, GV.SC-07 (risks from suppliers identified, recorded, prioritized, assessed). NIST AI RMF MAP 4.1, MANAGE 3.1 (third-party risk treatment). OWASP LLM03:2025 (Supply Chain), LLM04:2025 (Data and Model Poisoning). OWASP ASI04:2026 (Agentic Supply Chain Vulnerabilities), ASI06:2026 (Memory & Context Poisoning). NIST SP 800-218 v1.1 PS.2. NIST SP 800-218 Rev. 1 draft (Dec 17, 2025). NIST SP 800-218A (Generative AI Profile of SSDF). OWASP MCP01:2025, MCP03:2025, MCP04:2025.
