...
- **CISA, "Continuous Diagnostics and Mitigation (CDM) Identity, Credential, and Access Management (ICAM) Reference Architecture," Version 1.3** (September 2023). Source of the PE-to-NPE control sentence used in the DoD example. Note what it is: Section 3 is headed **Assumptions**, the sentence reads "an NPE **would be** under the control of an authorized PE," and the same list scopes the document to NPEs "that are considered privileged." It is not a FICAM or DoD mandate over every NPE, and this repo cited it as one until 2026-09-21. <https://www.cisa.gov/sites/default/files/2023-09/CDM-ICAM_Reference_Architecture_508c.pdf>
...
- **NIST SP 800-53 Rev. 5** (Rev. 5.2.0 finalized August 2025 per EO 14306). 1,196 controls across 20 families. Resolved baselines from NIST's own OSCAL profiles, counted 2026-09-21: **Low 149, Moderate 287, High 370** including control enhancements (131, 177 and 188 base controls respectively), then tailored. *Correction, 2026-09-21:* this entry previously read "Low ~77, Moderate ~323, High ~421", which matches no counting convention in SP 800-53B. The 1,196 and 20 figures beside it are correct, which is what made the wrong row easy to read past. Counted from `NIST_SP-800-53_rev5_{LOW,MODERATE,HIGH}-baseline-resolved-profile_catalog.json` at <https://github.com/usnistgov/oscal-content>. Rev. 5 is **outcome-based rather than prescriptive**, which is precisely what lets an admission policy or a PreToolUse hook satisfy a control: any technology that demonstrably achieves the outcome can be the implementation. Families this matrix touches most: **AC** (Access Control), **AU** (Audit and Accountability), **CA** (Assessment, Authorization, and Monitoring), **CM** (Configuration Management), **CP** (Contingency Planning), **IA** (Identification and Authentication), **IR** (Incident Response), **RA** (Risk Assessment), **SA** (System and Services Acquisition), **SC** (System and Communications Protection), **SI** (System and Information Integrity), **SR** (Supply Chain Risk Management), **PM** (Program Management).
...
- **DoD ICAM** (DoD ICAM Strategy; DoD Enterprise ICAM Reference Design; DoDI 8520.03; NIST SP 800-63 for IAL/AAL). Four domains: Identity Management, Credential Management, Access Management, Governance. Covers Non-Person Entities. **The PE-control sentence this repo used to attribute here is not from any of these documents**; it is CISA CDM's, cited above, and the DoD ICAM Strategy contains no such statement. Corrected 2026-09-21. Live deadlines: automated access workflows available to system and application owners by **June 2026**; by **September 2026**, all access requests processed through automated workflows **for systems and applications that have onboarded to approved ICAM providers**; full retirement of the paper DD Form 2875 SAAR by **September 2027**, except where policy exceptions are granted; financial systems on automated ICAM provisioning by **end of FY2026**. *Corrected 2026-09-21:* this entry previously attached the DD Form 2875 retirement to the September 2026 date and dropped the onboarded-systems qualifier, which widened the obligation for a program office reading it as a deadline. **Sourcing note:** the DoD CIO article and the Federal News Network piece both return HTTP 403 to automated retrieval, so these dates rest on two independent summaries of those pages that agree, not on a primary read. Open <https://dodcio.defense.gov/In-the-News/Article/4409965/automated-workflow-for-system-access/> in a browser before relying on them.
...
**Standing caveat for federal readers:** the Congressional Research Service reports there is **no official US government guidance or policy specifically on agentic AI** (CRS IF13151, *Agentic Artificial Intelligence and Cyberattacks*). Re-checked 2026-09-17 and still accurate. The exact revision date is given as July 6, 2026 in earlier versions of this file; congress.gov returns HTTP 403 to automated retrieval, so that revision is **confirmed indexed rather than read**, and secondary indexes list earlier 2026 revisions as well. Treat the substance as verified and the specific revision date as unconfirmed.

  **Legislation is moving, and none of it is law yet.** Three competing bills appeared inside ninety days: the **Warner AI AGENT Act** (S.5051, introduced July 21, 2026), the **Stop Rogue AI Act** (Gottheimer and Lawler, introduced September 3, 2026, which would direct NIST to set security standards for autonomous agents within a year), and the **Ban ASI Act**. Introduced is not enacted, and a program office cannot cite any of them today. They matter here because the Stop Rogue AI Act would put the NIST agent-security standards this framework crosswalks to on a statutory clock, which would change the federal section from advisory crosswalk to something closer to a mapping against a mandate.

  The Five Eyes joint guidance is advisory, not directive. The mappings below are therefore *crosswalks a program can defend to an AO*, not compliance claims. Nothing here substitutes for your AO's determination.
...
- **EU AI Act, Regulation (EU) 2024/1689** (entered force August 1, 2024). Phased applicability: prohibitions and AI literacy from February 2, 2025; GPAI obligations from August 2, 2025 (Commission GPAI enforcement powers activating August 2, 2026). **The "Digital Omnibus on AI" is now law: Regulation (EU) 2026/1744**, adopted by Parliament June 16, 2026, approved by Council June 29, 2026, signed July 8, 2026, published in the Official Journal July 24, 2026, and **in force since July 27, 2026**. It defers the high-risk obligations: **Annex III** stand-alone systems (hiring, credit scoring, education, critical infrastructure) from August 2, 2026 to **December 2, 2027**, and **Annex I** systems embedded in already-regulated products (medical devices, machinery, toys) to **August 2, 2028**. Synthetic-content marking moves to December 2, 2026. The conditional "6 or 12 months after standards are confirmed" trigger that appeared in earlier drafts was **dropped from the final text**, so neither date depends on a further Commission decision. (Earlier versions of this file recorded the deferral as a provisional May 7, 2026 agreement and told readers to verify before relying on it. It is no longer provisional; this entry is the resolution of that caveat.)

  **Article 73 is not deferred.** It sits in Chapter IX, Section 2, and comes into force August 2, 2026 under Article 113. The Omnibus moved the Chapter III high-risk conformity obligations, not the post-market incident-reporting duty, so the reporting clocks below apply now even where a system's high-risk obligations do not. Verified against the article text on 2026-09-17. Maximum fines: EUR 35M or 7% of global turnover. Articles directly relevant: **Article 9** (risk management system), **Article 13** (transparency), **Article 14** (human oversight), **Article 15** (accuracy, robustness, cybersecurity), **Articles 26–29** (deployer obligations), and **Articles 72–73** (post-market monitoring and serious-incident reporting).
...
- **OWASP Top 10 for LLM Applications 2025** (released November 2024). The edition OWASP's own index presents as current, verified 2026-09-19 at <https://genai.owasp.org/llm-top-10/>, which lists `LLM01:2025` Prompt Injection, `LLM02:2025` Sensitive Information Disclosure, `LLM03:2025` Supply Chain, `LLM04:2025` Data and Model Poisoning, `LLM05:2025` Improper Output Handling, `LLM06:2025` Excessive Agency, `LLM07:2025` System Prompt Leakage, `LLM08:2025` Vector and Embedding Weaknesses, `LLM09:2025` Misinformation, `LLM10:2025` Unbounded Consumption. **These are the names this repo's citations mean.**

  *A 2026 page exists and its status is unresolved.* `genai.owasp.org/resource/owasp-genai-llm-top-10-2026/` returns HTTP 200 under the title "OWASP GenAI LLM Top 10 2026", but it does not render an item list, and the project index above still presents 2025 as current. **Whether a 2026 edition supersedes 2025, and whether it renumbers, is unconfirmed.** Tracked in [#12](https://github.com/peopleforrester/agentic-covenants/issues/12).

  *Correction, 2026-09-19:* an earlier revision of this entry, committed the same day, asserted that a 2026 edition had superseded 2025 and warned that the repo's identifiers might therefore denote the wrong risks. That was over-read from a navigation link on the 2026 page and is withdrawn. The index contradicts it. Recording the correction rather than quietly reverting it, because a file arguing for dated primary sourcing should show what happened when its own author skipped that step.

  Regardless of the 2026 question, citations here should carry the `:2025` suffix OWASP's own documents use. An unsuffixed identifier is ambiguous the moment any new edition lands.
- **OWASP Top 10 for Agentic Applications 2026** (released December 9, 2025 by OWASP GenAI Security Project). ASI01:2026 through ASI10:2026. Foregrounds two design principles: **Least Agency** and **Strong Observability**.
...
- **OWASP MCP Top 10**, project lead Vandana Verma Sehgal. **Not a released top-10.** The project's own page states "Phase 3 - Beta Release and Pilot Testing - We are here right now," and its items carry the `:2025` suffix. Verified at <https://owasp.org/www-project-mcp-top-10/> on 2026-09-19. Cite it as a beta, never alongside NIST CSF or ISO 42001 as settled taxonomy. Official names: MCP01:2025 Token Mismanagement & Secret Exposure, MCP02:2025 Privilege Escalation via Scope Creep, MCP03:2025 Tool Poisoning, MCP04:2025 Software Supply Chain Attacks & Dependency Tampering, MCP05:2025 Command Injection & Execution, **MCP06:2025 Prompt Injection via Contextual Payloads**, MCP07:2025 Insufficient Authentication & Authorization, MCP08:2025 Lack of Audit and Telemetry, MCP09:2025 Shadow MCP Servers, MCP10:2025 Context Injection & Over-Sharing.

  *Correction, 2026-09-19:* this file previously named MCP06:2025 "Intent flow subversion". No OWASP MCP item carries that name. It was wrong in the file whose stated job is being the line of defense against "you just made this up", which makes it the worst kind of error this repo can contain.
...
|---|---|---|---|---|---|---|---|
| In-agent | System prompt declares agent identity (advisory; no enforcement) | (advisory; no direct mapping) | GOVERN 1.5; MAP 4.1 | LLM07:2025 (related risk) | ASI03:2026 (mitigation principle) | ISO/IEC 42001 §8.2 | NISTIR 8596 (overlay) |
| Client-side | Per-agent credentials, no shared keys, filesystem ACLs | PR.AA-01; PR.AA-03 | MANAGE 2.4 | LLM02:2025 | ASI03:2026 | ISO/IEC 42001 §A.7 | NIST SP 800-207 (Zero Trust); NIST SP 800-63 Rev. 4 |
| Server-side | Dedicated ServiceAccount, OIDC federation, short-TTL bound tokens, SPIFFE/SPIRE | PR.AA-01; PR.AA-02; PR.AA-03; PR.AA-04 | MANAGE 4.1 | LLM02:2025; LLM06:2025 | ASI03:2026; ASI10:2026 | EU AI Act Art. 14; ISO/IEC 42001 §A.7 | NIST SP 800-207 §3.4.1; NIST SP 800-63B Rev. 4; **NIST NCCoE Concept Paper on Software and AI Agent Identity and Authorization (Feb 5, 2026); Singapore IMDA Agentic AI Framework (Jan 22, 2026)** |

## Authorization row

| Layer | Control | NIST CSF 2.0 | NIST AI RMF | OWASP LLM | OWASP Agentic | EU AI Act / ISO | Other |
|---|---|---|---|---|---|---|---|
| In-agent | Model instructions, scoped tool descriptions | (advisory; no direct mapping) | MAP 5.1; MAP 5.2 | LLM06:2025 (mitigation principle) | ASI02:2026 (mitigation principle) | ISO/IEC 23894 | NIST AI 100-2 E2025 (adversarial ML) |
| Client-side | `--allowedTools` deny-by-default, capability-based tool restriction, PreToolUse hooks (deny-then-ask-then-allow), operator-owned hook config | PR.AA-05; PR.PS-01 | MANAGE 2.4; MANAGE 4.1 | LLM06:2025; LLM05:2025 | ASI02:2026; ASI05:2026; OWASP Least Agency principle | EU AI Act Art. 14, Art. 15 | NIST SP 800-207 §2.1; OWASP MCP02:2025, MCP05:2025 |
| Server-side | Scoped RBAC Roles, IAM with explicit ARN, Kyverno or OPA admission, namespace scoping | PR.AA-05; PR.PS-01; PR.PS-05 | MANAGE 2.4; MANAGE 4.1 | LLM06:2025; LLM05:2025 | ASI02:2026; ASI03:2026; ASI05:2026 | EU AI Act Art. 15; ISO/IEC 42001 §A.6 | NIST SP 800-207 (Zero Trust); CIS Kubernetes Benchmark; NISTIR 8596 |

## Blast radius row

| Layer | Control | NIST CSF 2.0 | NIST AI RMF | OWASP LLM | OWASP Agentic | EU AI Act / ISO | Other |
|---|---|---|---|---|---|---|---|
| In-agent | (no enforcement; advisory only) | (no mapping) | MAP 5.1; MEASURE 2.6, 2.7 | LLM06:2025 | ASI02:2026; ASI05:2026 |, |, |
| Client-side | Sandbox at launch (bubblewrap, Seatbelt, gVisor), unix-domain-socket egress proxy, seccomp or AppArmor, `--network none`, read-only mounts, dry-run defaults | PR.PS-01; PR.PS-05; PR.IR-01; PR.PS-06 | MANAGE 2.4 | LLM05:2025; LLM10:2025 | ASI05:2026; ASI02:2026 | EU AI Act Art. 15 | NIST SP 800-160 Vol. 1 (defense in depth); **Anthropic Auto Mode and Sandbox publications (March 2026)** |
| Server-side | Gated IaC apply pipeline, ResourceQuota, NetworkPolicy default-deny, prod and non-prod separation, immutable backups | PR.IR-01; PR.IR-02; PR.IR-03; PR.IR-04; PR.DS-11 | MANAGE 2.4; MANAGE 4.1 | LLM10:2025; LLM05:2025 | ASI05:2026; ASI08:2026 | EU AI Act Art. 15 | NIST SP 800-160 Vol. 1; NIST SP 800-34 Rev. 1; NISTIR 8596 |

## Approval gating row

| Layer | Control | NIST CSF 2.0 | NIST AI RMF | OWASP LLM | OWASP Agentic | EU AI Act / ISO | Other |
|---|---|---|---|---|---|---|---|
| In-agent | Model self-pause ("are you sure?") | (advisory; no direct mapping) | MANAGE 4.1 | LLM06:2025 | ASI09:2026 (related risk) | EU AI Act Art. 14 | **Anthropic Auto Mode (March 2026): 93% approval rate is the empirical ceiling** |
| Client-side | PreToolUse pattern hooks, tiered confirmation, session limits, out-of-band channel for tier-3, judgment-query escalation | PR.AA-05; PR.PS-01 | MANAGE 4.1 | LLM06:2025 | ASI02:2026; ASI09:2026 | EU AI Act Art. 14; **Singapore IMDA "meaningful human accountability" dimension** | OWASP Least Agency principle; assistance-games framing (Russell, 2019); AHRQ PSNet alarm-fatigue research |
| Server-side | Branch protection plus PR review (with admin bypass disabled), CODEOWNERS, multi-party prod approval, plan-and-apply separation, deployment freezes | PR.AA-05; PR.PS-01; **GV.RR-02** (roles, responsibilities, and authorities established, communicated, understood, and enforced); **GV.SC-04** (suppliers known and prioritized) | GOVERN 4.1; MANAGE 4.1 | LLM06:2025 | ASI02:2026; ASI03:2026 | EU AI Act Art. 14, Art. 26; ISO/IEC 42001 §A.4 | NIST SP 800-160 Vol. 1 |

## Supply chain row

| Layer | Control | NIST CSF 2.0 | NIST AI RMF | OWASP LLM | OWASP Agentic | EU AI Act / ISO | Other |
|---|---|---|---|---|---|---|---|
| In-agent | (no enforcement; advisory only) | (no mapping) | MAP 4.1 | LLM03:2025 (related risk) | ASI04:2026 (mitigation principle) |, |, |
...
| **Supply chain** | **SR** family (SR-3, SR-4 provenance, SR-5, SR-11 component authenticity), SA-11, CM-14 (signed components), SI-7 (software/firmware integrity) | **Application & Workload**, **Data** | cATO SSSC; CSRMC DevSecOps | Reliable, Traceable |
...
- **SA-12** (Supply Chain Protection) was **withdrawn** in SP 800-53 Rev. 5 and incorporated into the SR family. NIST's OSCAL catalog marks it `status: withdrawn`, verified 2026-09-21. This file cited it in a column headed "Rev. 5 families" until then; the SR family it was folded into was already cited on the same row.
